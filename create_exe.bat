...
pyinstaller --onefile --collect-all "orangeshare" --add-data "orangeshare/logo/gray.png;orangeshare/logo" --name=orangeshare-console --icon=orangeshare/logo/white.ico main.py
